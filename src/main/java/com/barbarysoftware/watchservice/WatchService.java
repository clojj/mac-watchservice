...
public abstract class WatchService implements Closeable {
     ...
     * it immediately receives a {@link com.barbarysoftware.watchservice.ClosedWatchServiceException}. Any
     * valid keys associated with this watch service are {@link com.barbarysoftware.watchservice.WatchKey#isValid
     * invalidated}.
     * <p/>
     * <p> After a watch service is closed, any further attempt to invoke
     * operations upon it will throw {@link com.barbarysoftware.watchservice.ClosedWatchServiceException}.
     ...
     * @throws com.barbarysoftware.watchservice.ClosedWatchServiceException if this watch service is closed
     */
     ...
     *                parameter
     * @return the next watch key, or {@code null}
     * @throws com.barbarysoftware.watchservice.ClosedWatchServiceException if this watch service is closed, or it is closed while waiting
     *                                     for the next key
