...
public final class StandardWatchEventKind {
     ...
     * discarded.
     *
     * <p> The {@link com.barbarysoftware.watchservice.WatchEvent#context context} for this event is
     * implementation specific and may be {@code null}. The event {@link
     * com.barbarysoftware.watchservice.WatchEvent#count count} may be greater than {@code 1}.
     *
     * @see com.barbarysoftware.watchservice.WatchService
     */
     ...
     *
     * <p> When a directory is registered for this event then the {@link com.barbarysoftware.watchservice.WatchKey}
     * is queued when it is observed that an entry is created in the directory
     * or renamed into the directory. The event {@link com.barbarysoftware.watchservice.WatchEvent#count count}
     ...
     * the directory. The event {@link com.barbarysoftware.watchservice.WatchEvent#count count} for this event
     * is always {@code 1}.
     */
     ...
     * modified. The event {@link com.barbarysoftware.watchservice.WatchEvent#count count} for this event is
     * {@code 1} or greater.
     */
