...
public abstract class WatchEvent<T> {
     ...
     *
     * @since 1.7
     * @see com.barbarysoftware.watchservice.StandardWatchEventKind
     */
    public static interface Kind<T> {
        ...
        /**
         * Returns the type of the {@link com.barbarysoftware.watchservice.WatchEvent#context context} value.
         */
        Class<T> type();
    }
    ...
    /**
     * An event modifier that qualifies how a {@link com.barbarysoftware.watchservice.Watchable} is registered
     * with a {@link com.barbarysoftware.watchservice.WatchService}.
     *
     * <p> This release does not define any <em>standard</em> modifiers.
     *
     * @since 1.7
     * @see com.barbarysoftware.watchservice.Watchable#register
     */
     ...
     *
     * <p> In the case of {@link com.barbarysoftware.watchservice.StandardWatchEventKind#ENTRY_CREATE ENTRY_CREATE},
     * {@link com.barbarysoftware.watchservice.StandardWatchEventKind#ENTRY_DELETE ENTRY_DELETE}, and {@link
     * com.barbarysoftware.watchservice.StandardWatchEventKind#ENTRY_MODIFY ENTRY_MODIFY} events the context is
     * a {@code File}.
     *
